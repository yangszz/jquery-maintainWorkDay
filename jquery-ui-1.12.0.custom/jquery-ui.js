...
$.extend( Datepicker.prototype, {
	...
	/* Action for choose a day. */
	_chooseDay: function( id, month, year, td ) {
		var inst,
			target = $( id );
	...
	_attachHandlers: function( inst ) {
		...
		inst.dpDiv.find( "[data-handler]" ).map( function() {
			var handler = {
				...
				chooseDay: function() {
					$.datepicker._chooseDay( id, +this.getAttribute( "data-month" ), +this.getAttribute( "data-year" ), this );
					return false;
				}
				...
				for ( dRow = 0; dRow < numRows; dRow++ ) { // create date picker rows
					...
					for ( dow = 0; dow < 7; dow++ ) { // create date picker days
						...
						tbody += "<td class='" +
							...
							( unselectable ? "" : " data-handler='chooseDay' data-event='click' data-month='" + printDate.getMonth() + "' data-year='" + printDate.getFullYear() + "'" ) + ">" + // actions
							( otherMonth && !showOtherMonths ? "&#xa0;" : // display for other months
							( unselectable ? "<span class='ui-state-default'>" + printDate.getDate() + "</span>" : "<a name='huoquriqi' class='ui-state-default" +
							( printDate.getTime() === today.getTime() ? " ui-state-highlight" : "" ) +
							( printDate.getTime() === currentDate.getTime() ? " ui-state-active" : "" ) + // highlight selected day
							( ( dow + firstDay + 6 ) % 7 >= 5 ? " ui-state-active" : "" ) +
							( otherMonth ? " ui-priority-secondary" : "" ) + // distinguish dates from other months
							"' href='#' value='"+printDate.getFullYear() + 
